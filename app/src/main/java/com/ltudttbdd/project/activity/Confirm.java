...
public class Confirm extends AppCompatActivity {
    ...
    private void LoadMoreData() {
        ...
        listview.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView absListView, int firstItem, int visibleItem, int totalItem) {
                if (firstItem + visibleItem == totalItem && totalItem != 0 && isLoading == false && limitData == false) {
                    isLoading = true;
                    Confirm.ThreadData threadData = new Confirm.ThreadData();
                    threadData.start();
                }
            }
        });
        ...
        private void GetData(int page) {
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Server.urlconfirm, jsonObject, new Response.Listener<JSONObject>() {
                @Override
        ...
        private void ActionToolbar() {
            ...
            getSupportActionBar().setTitle("Đơn hàng đã xác nhận");
            ...
            toolbar.setNavigationOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent signin = new Intent(Confirm.this, OrderPreview.class);
